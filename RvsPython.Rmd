...
With R you can work with dataframes directly. For Python we need to use the Pandas package.
...
####e. Rename columns
Assign a vector to column names
```{r cache=TRUE}
#R
...
In Python we can assign a list to df.columns
```{python cache=TRUE}
#Python
import sklearn as sklearn
import pandas as pd
...
# Chaining operations on dataframes
